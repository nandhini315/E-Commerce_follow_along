...
## Milestone 3 :
set up dedicated folders for organizing backend code effectively. initialized and configured a Node.js server to handle API requests. Connected the application to Mongoos to store and manage data. Implemented basic error handilng to ensure smooth server operation 